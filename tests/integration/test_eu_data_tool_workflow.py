...
class TestLiveEUDataTool:
    ...
    TEST_DATASET_URI = "http://data.europa.eu/88u/dataset/54336a93-2478-44fc-bb78-696c77cff5c2" # TODO - this source indicates a dataset that is served with an HTTPS certificate whos intermediate is misconfigured, causing SSL validation to fail. This is likely temporary
    ...
    def test_cache_functionality(self, data_tool, tmp_path):
        ...
        # Test force refresh
        start_time = time.time()
        metadata3 = data_tool.get_dataset_metadata(self.TEST_DATASET_URI, force_refresh=True)
    ...
    def test_get_dataset_content(self, data_tool, mock_requests):
        ...
        assert "CSV" in format_str or "JSON" in format_str, (
